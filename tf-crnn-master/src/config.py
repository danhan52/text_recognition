...
class Alphabet:
    MY_ALPHABET = " !\"#&'()*+,-./0123456789:;<=>?ABCDEFGHIJKLMNOPQRSTUVWXY[]_abcdefghijklmnopqrstuvwxyz|£§àâèéê⊥"
    ...
    AlphabetsList = [DIGITS_ONLY, LETTERS_DIGITS, LETTERS_DIGITS_LOWERCASE, LETTERS_ONLY, LETTERS_ONLY_LOWERCASE,
                     ...
                     LETTERS_DIGITS_EXTENDED_LOWERCASE, MY_ALPHABET]
